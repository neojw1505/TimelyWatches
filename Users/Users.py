...
2. GET /user/<string:email> - Get a specific user by user email
3. GET /user/id/<int:user_id> - Get a specific user by user_id
4. POST /user/<string:email> - Create a user
5. PUT /user/<string:email> - Edit a user
6. DELETE /user/<string:email> - Delete a user
7. POST /user/login/<string:email> - Check user password
